        ...
        {EXPERIENCE_DATA.map((item, index) => {
          ...
          return (
            <div key={item.id} className="relative pl-8 md:pl-12 transition-all duration-300">
              {/* Timeline Dot */}
              <div
                className={`absolute -left-[9px] top-6 w-5 h-5 rounded-full border-4 transition-all duration-300 z-10 ${isExpanded ? 'bg-primary-600 border-white shadow-lg scale-110' : 'bg-slate-300 border-white'
                  }`}
              />
              ...
              <div
                ...
                className={`cursor-pointer bg-white p-6 rounded-xl border transition-all duration-300 shadow-sm hover:shadow-md ${isExpanded ? 'border-primary-200 ring-1 ring-primary-100' : 'border-slate-100 hover:border-slate-200'
                  }`}
              >
                  ...
                  <div className="min-h-0 space-y-6">
                    ...
                    <div className="pt-2">
                      ...
                      <div className="mt-4 pt-4 border-t border-slate-100">
                        <a href="/Resume_Venu_MBA.pdf" download aria-label="Download Venu Gopinath's MBA Resume" className="group text-primary-600 hover:text-primary-800 font-semibold text-sm inline-flex items-center transition-colors">
